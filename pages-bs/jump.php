...
<html lang="en">
    <head>
        ...
        <script src="../assets-bs/js/components/jquery.bxslider.min.js"></script>
        <link href="../assets-bs/css/components/gijgo-datepicker.css" rel="stylesheet" type="text/css"/>
        <link rel="stylesheet" href="../assets-bs/css/components/jquery.bxslider.css">
            ...
            <section class="container wow fadeInUp">
                ...
                <div class="row" id="modals">
                    <div class="col-md-6">
                        ...
                        <div class="bxslider">
                            <div><img src="../assets-bs/images/bg1.jpg" title="Hand On the Hammock"></div>
                            <div><img src="../assets-bs/images/bg4.jpg" title="Up On the Roof"></div>
                            <div><img src="../assets-bs/images/bg5.jpg" title="The Chinese Dragon"></div>
                        </div>
                        <script>
                            $(function () {
                                $('.bxslider').bxSlider({
            ...
            <section class="container wow fadeInUp">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        ...
                        <img src="../assets-bs/images/avatar.jpg" alt="Rounded Image" class="rounded">
                    </div>
                    <div class="col-sm-2">
                        <p class="category">Circle Image</p>
                        <img src="../assets-bs/images/avatar.jpg" alt="Circle Image" class="rounded-circle">
                    </div>
                    <div class="col-sm-2">
                        <p class="category">Raised</p>
                        <img src="../assets-bs/images/avatar.jpg" alt="Raised Image" class="rounded img-raised">
                    </div>
                    <div class="col-sm-2">
    ...
    .grand-child  {
      ...
      &.sibling {
        color:purple;
            ...
            <hr/>
            <section id="middle" class="wow fadeInUp">
                <div class="container">
                    <h2>Parallax</h2>
                </div>
