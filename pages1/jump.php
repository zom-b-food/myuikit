...
<html lang="en">
    <head>
        ...
        <script src="../assets1/js/components/gijgo-datepicker.js" type="text/javascript"></script>
        <script src="../assets1/js/components/jquery.bxslider.min.js"></script>
        <link href="../assets1/css/components/gijgo-datepicker.css" rel="stylesheet" type="text/css"/>
        <link rel="stylesheet" href="../assets1/css/components/jquery.bxslider.css">
        <link rel="stylesheet" href="../assets1/css/components/nouislider.css">
    </head>
    <body class="sidebar-collapse" id="top">
        <div class="se-pre-con"></div>
        <?php include '../sitewide1/a-header.php'; ?>
        <main role="main">
            <section class="container wow fadeInUp">
                ...
                <div class="row" id="modals">
                    <div class="col-md-6">
                        ...
                        <div class="bxslider">
                            <div><img src="../assets1/images/bg1.jpg" title="Hand On the Hammock"></div>
                            <div><img src="../assets1/images/bg4.jpg" title="Up On the Roof"></div>
                            <div><img src="../assets1/images/bg5.jpg" title="The Chinese Dragon"></div>
                        </div>
                        <script>
                            $(function () {
                                $('.bxslider').bxSlider({
  ...
  .child {
    ...
    .grand-child  {
      ...
      &.sibling {
        ...
        <?php
        $count_my_page = ("countlog-green.txt");
