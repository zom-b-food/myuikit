...
public class authEmail extends HttpServlet {
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			props.put("mail.smtp.host", "venus.ignitionserver.net");
			props.put("mail.from", "web@myuikit.com");
			props.put("mail.smtp.username", "web+myuikit.com");
			props.put("mail.smtp.password", "#9794Coralrd");
			...
			transport.connect("venus.ignitionserver.net", "web@myuikit.com", "#9794Coralrd");
			transport.send(msg);
...
class SMTPAuthenticator extends Authenticator {
	protected PasswordAuthentication getPasswordAuthentication() {
		return new PasswordAuthentication("web@myuikit.com", "#9794Coralrd");
	}
}
