...
<html lang="en">
    <head>
        ...
        <title>Shortcode Accordion</title>
        ...
        <section class="section-padding">
            <div class="container">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <h2 class="mb-30">Accordion Style One</h2>
                ...
                <div class="col-md-6">
                  <h2 class="mb-30">Accordion Style Two</h2>
                  <div class="panel-group feature-accordion pink-accordion icon plus-icon" id="accordion-two">
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        <h3 class="panel-title">
                          <a class="collapsed" data-toggle="collapse" data-parent="#accordion-two" href="#collapse-v2-two">
                            Super Creative
                          </a>
                        </h3>
                      </div>
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        <h3 class="panel-title">
                          <a class="collapsed" data-toggle="collapse" data-parent="#accordion-two" href="#collapse-v2-three">
                            Awesome Customer Servicers
                          </a>
                        </h3>
                      </div>
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        <h3 class="panel-title">
                          <a class="collapsed" data-toggle="collapse" data-parent="#accordion-two" href="#collapse-v2-four">
                            Hard Working Team
                          </a>
                        </h3>
                      </div>
        ...
        <section class="padding-bottom-100">
            <div class="container">
              <div class="row">
                ...
                <div class="col-md-6">
                  <h2 class="mb-30">Accordion Style Three</h2>
                ...
                <div class="col-md-6">
                  <h2 class="mb-30">Accordion Style Four</h2>

                  <div class="panel-group flat-accordion solid-bg brand-bg z-depth-1" id="flat-two">
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        <h3 class="panel-title">
