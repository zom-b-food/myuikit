...
<html lang="en">
    <head>
        ...
        <title>Shortcode Pricing Table</title>
    ...
    <body id="top" class="has-header-search">
        ...
        <!--page title start-->
        <section class="page-title ptb-50 white">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2>Pricing Table</h2>
        ...
        <section class="section-padding gray-bg">
            <div class="container">
              ...
              <div class="text-center mb-80">
                  <h2 class="section-title text-uppercase">Pricing table 3</h2>
        ...
        <section class="padding-bottom-100 gray-bg">
            <div class="container">

              <div class="text-center mb-80">
                  <h2 class="section-title text-uppercase">Pricing table 4</h2>
                  <p class="section-sub">Quisque non erat mi. Etiam congue et augue sed tempus. Aenean sed ipsum luctus, scelerisque ipsum nec, iaculis justo. Sed at vestibulum purus, sit amet viverra diam nulla ac nisi rhoncus.</p>
              </div>
