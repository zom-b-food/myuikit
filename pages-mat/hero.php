...
<html lang="en">
    <head>
        ...
        <title>Shortcode Hero Block</title>
    ...
    <body id="top" class="has-header-search">
                    ...
                    <div class="col-md-7">
                      <div class="valign-wrapper equal-height-column">
                        <div class="hero-intro valign-cell">
                            <h2 class="font-40 line-height-50 mb-40">We help you to create a successful brand</h2>

                            <p class="no-margin">Quisque non erat mi. Etiam congue et augue sed tempus. Aenean sed ipsum luctus, scelerisque <a href="#">ipsum nec</a>, iaculis justo. Sed at vestibulum purus, sit amet viverra diam. Nulla ac nisi rhoncus,</p>
                        </div><!-- /.hero-intro -->
                      </div><!-- /.container -->
                    </div>

                    <div class="col-md-5 hero-thumb equal-height-column">
                        <img src="../assets-mat/img/mockup/ipad.png" class="img-responsive " alt="Image">
                    </div>
                </div>
            </div><!-- /.container -->
        </section>
        ...
        <section class="banner-5 bg-fixed parallax-bg overlay dark-5 padding-top-100" data-stellar-background-ratio="0.5">
            <div class="container">
            ...
            <div class="mocup-wrapper text-center">
                <img src="../assets-mat/img/mockup/mockup.png" alt="">
            </div>
        </section>
        ...
        <div class="container section-padding">
            <div class="row">
                ...
                <div class="col-md-5">
                    <img src="../assets-mat/img/mockup/ipad-2.png" class="img-responsive " alt="Image">
                </div>
            </div>
        </div><!-- /.container -->
