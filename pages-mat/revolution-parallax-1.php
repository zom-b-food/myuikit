    ...
    <body id="top">
        ...
        <section class="section-padding">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <p>Authoritatively enable robust testing procedures with resource-leveling e-markets.
                            Competently visualize visionary e-commerce with multifunctional ROI. Collaboratively
                            visualize installed base communities and customer directed potentialities. Interactively
                            create distributed channels through just in.</p>
                    </div>
                    <div class="col-md-4">
                        <p>Authoritatively enable robust testing procedures with resource-leveling e-markets.
                            Competently visualize visionary e-commerce with multifunctional ROI. Collaboratively
                    ...
                    <div class="col-md-12">
                        <p>Authoritatively enable robust testing procedures with resource-leveling e-markets.
                            Competently visualize visionary e-commerce with multifunctional ROI. Collaboratively
                            visualize installed base communities and customer directed potentialities. Interactively
                            create distributed channels through just in enable robust testing procedures with
                            resource-leveling e-markets. Competently visualize visionary e-commerce with multifunctional
                            ROI. Collaboratively visualize installed base communities and customer directed
                            potentialities aboratively visualize installed base.</p>
        ...
        <script type="text/javascript"
                src="../assets-mat/revolution/js/extensions/revolution.extension.video.min.js"></script>
        <script type="text/javascript"
                src="../assets-mat/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
        <script type="text/javascript"
                src="../assets-mat/revolution/js/extensions/revolution.extension.actions.min.js"></script>
        <script type="text/javascript"
                src="../assets-mat/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
        <script type="text/javascript"
                src="../assets-mat/revolution/js/extensions/revolution.extension.kenburn.min.js"></script>
        <script type="text/javascript"
                src="../assets-mat/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
        <script type="text/javascript"
                src="../assets-mat/revolution/js/extensions/revolution.extension.migration.min.js"></script>
        <script type="text/javascript"
